...
const CallOptions = (0, ts_poet_1.imp)('CallOptions@@grpc/grpc-js');
...
const ClientUnaryCall = (0, ts_poet_1.imp)('ClientUnaryCall@@grpc/grpc-js');
...
const handleUnaryCall = (0, ts_poet_1.imp)('handleUnaryCall@@grpc/grpc-js');
const UntypedServiceImplementation = (0, ts_poet_1.imp)('UntypedServiceImplementation@@grpc/grpc-js');
...
const ServiceError = (0, ts_poet_1.imp)('ServiceError@@grpc/grpc-js');
/**
