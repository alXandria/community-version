...
var Trouter__default = /*#__PURE__*/_interopDefaultLegacy(Trouter);
...
function factory({
  ...
  nc.routes = [];
  const _use = Trouter__default["default"].prototype.use.bind(nc);
  const _find = Trouter__default["default"].prototype.find.bind(nc);
  const _add = Trouter__default["default"].prototype.add.bind(nc);
