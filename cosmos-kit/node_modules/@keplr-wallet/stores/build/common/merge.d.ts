 ...
 */
export declare type Functionify<Params extends Array<any>, Return> = (...p: Params) => Return;
/**
 ...
 */
export declare type ChainedFunctionifyTuple<Base extends IObject, Params extends Array<any>, Injects extends Array<any>> = Injects extends [infer Head, ...infer Tail] ? [
 ...
 */
export declare const mergeStores: <Base extends IObject, Params extends any[], Injects extends IObject[], Return = Base & UnionToIntersection<Injects[number]>>(baseStore: Base, parameters: Params, ...fns: ChainedFunctionifyTuple<Base, Params, Injects>) => Return;
