(function (global, factory) {
        ...
        return _a = {
                subscribe: function (observer) {
                    if ("function" === typeof observer) {
                        return {
                            unsubscribe: mobx.observe(computedValue, function (_a) {
        ...
        function ViewModel(model) {
            ...
            getAllMethodsAndProperties(model).forEach(function (key) {
                ...
                if (mobx.isComputedProp(model, key)) {
                    var computedBox = mobx._getAdministration(model, key); // Fixme: there is no clear api to get the derivation
                    var get = computedBox.derivation.bind(_this);
                    var set = (_a = computedBox.setter_) === null || _a === void 0 ? void 0 : _a.bind(_this);
                    _this.localComputedValues.set(key, mobx.computed(get, { set: set }));
                }
    ...
    function keepAlive(_1, _2) {
        ...
        return mobx.observe(computed, function () { });
    }
