...
exports.babelPluginTsdx = rollup_plugin_babel_1.default.custom(() => ({
        ...
        if (presetEnvIdx !== -1) {
            ...
            babelOptions.presets[presetEnvIdx] = core_1.createConfigItem([
                ...
                lodash_merge_1.default({
                    ...
                    modules: false,
                    exclude: lodash_merge_1.default(['transform-async-to-generator', 'transform-regenerator'], (presetEnv.options && presetEnv.options.exclude) || []),
                }),
            ], {
                type: `preset`,
            });
